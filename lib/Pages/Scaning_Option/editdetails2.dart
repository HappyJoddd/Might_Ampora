...
class EditDetailsPage2 extends StatefulWidget {
  final Map<String, dynamic> data;

  const EditDetailsPage2({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  State<EditDetailsPage2> createState() => _EditDetailsPage2State();
}

class _EditDetailsPage2State extends State<EditDetailsPage2> {
  ...
  void _calculateCost() {
    if (_formKey.currentState!.validate()) {
      ...
      // Navigate back to detail2 page with updated data
        ...
        MaterialPageRoute(
          builder: (context) => DeviceDetailsPage2(
            data: {
              ...
              "beeRating": widget.data['beeRating'] ?? 3, // Keep existing BEE rating
